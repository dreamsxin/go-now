...
// With initialize Now with last week time
func WithLastWeek() *Now {
...
// With initialize Now with last month time
func WithLastMonth() *Now {
...
// With initialize Now with last year time
func WithLastYear() *Now {
